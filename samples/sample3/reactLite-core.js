// ==========================================
// === REACT LITE - CORE FRAMEWORK ===
// ==========================================
// Alapvető infrastruktúra: Event System, Virtual DOM, Component Registry, Hooks
...
class ComponentRegistry {
  ...
  renderOne(id) {
    ...
    this.virtualDOM.updateDOM(id, newHTML, comp.rootSelector);
  }
